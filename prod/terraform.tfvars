...
#s3 variables
env_file_bucket_name = "kobosky-ecs-env-file-bucket"
env_file_name        = "e-learning.env"

# ecs variable ******if you built your image on windows use X86_64 ******* if you use LINUX use ARM64
architecture    = "X86_64"
container_image = "562834173446.dkr.ecr.eu-west-2.amazonaws.com/nginx-image:latest"
